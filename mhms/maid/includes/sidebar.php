 <nav id="sidebar">
               <div class="sidebar_blog_1" style="background-color: #10477c;;height: 770px;">
                  <div class="sidebar-header" style="background-color: #10477c;">
                     <div class="logo_section">
                        <a href="dashboard.php"><img class="logo_icon img-responsive" src="images\image 9.png" alt="#" /></a>
                     </div>
                  </div>
                  
               <div class="sidebar_blog_2">
                  <h4 style="background-color: #10477c;;border-bottom: solid #ce0689 1px ">General Details</h4>
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="element">
                           <li><a href="add-maid.php">> <span>Add Personal Details</span></a></li>
