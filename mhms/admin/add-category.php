...
// } else {
    if (isset($_POST['submit'])) {
        ...
        $amt = $_POST['amt']; // Add this line to get the amount from the form

        $sql = "insert into tblcategory(CategoryName, Amount) values(:catname, :amt)";
        $query = $dbh->prepare($sql);
        $query->bindParam(':catname', $catname, PDO::PARAM_STR);
        $query->bindParam(':amt', $amt, PDO::PARAM_STR); // Bind the amount parameter

        $query->execute();

        $LastInsertId = $dbh->lastInsertId();
        if ($LastInsertId > 0) {
            echo '<script>alert("Category and amount has been added.")</script>';
                  ...
                  <div class="container-fluid">
                     ...
                     <div class="row column8 graph">
                        ...
                        <fieldset>
                           ...
                           <div class="field">
                              <label class="label_field">Amount</label>
                              <input type="text" name="amt" value="" class="form-control" required='true'>
                           </div>
