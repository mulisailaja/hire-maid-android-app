...
if (isset($_POST['submit'])) {
    ...
    $perHourAmt = $_POST['per_hour_amt'];
    $monthlyAmt = $_POST['monthly_amt'];
    $eid = $_GET['editid'];
                                       ...
                                       <div class="full">
                                          ...
                                          <fieldset>
                                             ...
                                             <div class="field">
                                                ...
                                                <input type="text" name="per_hour_amt" value="<?php echo htmlentities($row->PerHourAmount); ?>" class="form-control" required='true'>
                                             </div>
                                             <div class="field">
                                                <label class="label_field">Monthly Amount</label>
                                                <input type="text" name="monthly_amt" value="<?php echo htmlentities($row->MonthlyAmount); ?>" class="form-control" required='true'>
                                             </div>
                                             <?php } ?>
                                          </fieldset>
                                          <?php } ?>
